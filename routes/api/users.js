...
const { userJoiSchema, subscriptionUserSchema, verifyEmailJoiSchema } = require("../../models/user");
...
router.post("/verify/", validateBody(verifyEmailJoiSchema), ctrl.resendVerificationEmailUser);
